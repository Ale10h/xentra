...
function resultado_consumo(id_asoc){
    ...
    resultado_detalle(id_asoc);
}

//Tabla resultados de la busqueda en el index de cliente
function resultado_detalle(id_asoc)
{
    var base_url = document.getElementById('base_url').value;
                    ...
                    html += "<tr>";
                    html += "<td>"+1+"</td>";
                    html += "<td>Consumo Agua</td>";
                    html += "<td>";
                    html += "<input id='consumo_agua"+id_asoc+"' type='text' class='form-control' autocomplete='off' >";
                    html += "</td>";
                    html += "</tr>";
                    html += "<tr>";
                    html += "<td>"+2+"</td>";
                    html += "<td>Aportes</td>";
                    html += "<td>";
                    html += "<input id='aportes"+id_asoc+"' type='text' class='form-control' autocomplete='off' >";
                    html += "</td>";
                    html += "</tr>";
                    html += "<tr>";
                    html += "<td>"+3+"</td>";
                    html += "<td>Multas</td>";
                    html += "<td>";
                    html += "<input id='multas"+id_asoc+"' type='text' class='form-control' autocomplete='off' >";
                    html += "</td>";
                    html += "</tr>";
...
{
    var controlador = base_url+'lectura/buscarasociado/';
    var base_url = document.getElementById('base_url').value;
    ...
    $.ajax({url: controlador,
           type:"POST",
           data:{id_asoc:id_asoc, actual_lec:actual_lec, consumo_lec:consumo_lec,
