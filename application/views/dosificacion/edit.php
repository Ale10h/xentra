			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="estado_dosif" value="<?php echo ($this->input->post('estado_dosif') ? $this->input->post('estado_dosif') : $dosificacion['estado_dosif']); ?>" class="form-control" id="estado_dosif" />
						</div>
					</div>
					<div class="col-md-6">
