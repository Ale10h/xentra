          		...
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_emp" value="<?php echo $this->input->post('id_emp'); ?>" class="form-control" id="id_emp" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="zona_asoc" value="<?php echo $this->input->post('zona_asoc'); ?>" class="form-control" id="zona_asoc" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="categoria_asoc" value="<?php echo $this->input->post('categoria_asoc'); ?>" class="form-control" id="categoria_asoc" />
						</div>
					</div>
					<div class="col-md-6">
