				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_usu" value="<?php echo ($this->input->post('id_usu') ? $this->input->post('id_usu') : $ingreso['id_usu']); ?>" class="form-control" id="id_usu" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="estado_ing" value="<?php echo ($this->input->post('estado_ing') ? $this->input->post('estado_ing') : $ingreso['estado_ing']); ?>" class="form-control" id="estado_ing" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tipo_ing" class="control-label">Tipo Ing</label>
						<div class="form-group">
							<input type="text" name="tipo_ing" value="<?php echo ($this->input->post('tipo_ing') ? $this->input->post('tipo_ing') : $ingreso['tipo_ing']); ?>" class="form-control" id="tipo_ing" />
						</div>
					</div>
					<div class="col-md-6">
