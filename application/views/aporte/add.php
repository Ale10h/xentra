          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="mes_ap" value="<?php echo $this->input->post('mes_ap'); ?>" class="form-control" id="mes_ap" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="gestion_ap" class="control-label">Gestion Ap</label>
						<div class="form-group">
							<input type="text" name="gestion_ap" value="<?php echo $this->input->post('gestion_ap'); ?>" class="form-control" id="gestion_ap" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tipo_ap" class="control-label">Tipo Ap</label>
						<div class="form-group">
							<input type="text" name="tipo_ap" value="<?php echo $this->input->post('tipo_ap'); ?>" class="form-control" id="tipo_ap" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="estado_ap" class="control-label">Estado Ap</label>
						<div class="form-group">
							<input type="text" name="estado_ap" value="<?php echo $this->input->post('estado_ap'); ?>" class="form-control" id="estado_ap" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="exento_ap" value="<?php echo $this->input->post('exento_ap'); ?>" class="form-control" id="exento_ap" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="ice_ap" class="control-label">Ice Ap</label>
						<div class="form-group">
							<input type="text" name="ice_ap" value="<?php echo $this->input->post('ice_ap'); ?>" class="form-control" id="ice_ap" />
						</div>
					</div>
				</div>
			</div>
