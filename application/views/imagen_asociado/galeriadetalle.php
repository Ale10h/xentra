...
<div class="box-header">
    <h3 class="box-title">Galeria de imagenes de <b><?php echo $asociado; ?></b></h3>
...
<div class="row">
                ...
                <p>
                    <?php
                        ...
                        foreach($all_imagen_asociado as $imagen)
                        {
                            ...
                            //echo "<div id='colum5'>";
                            echo "<a class='fancybox' href='".site_url('/resources/images/asociado/'.$imagen['imagenasoc_archivo'])."' data-fancybox-group='gallery' title='".$imagen['imagenasoc_titulo']."'>";
                            echo "<img src='".site_url('/resources/images/asociado/'.$mimagen)."' alt='' /></a>";
                            //echo "</div>";
                            if(($cont % $colum) == 0){
                                echo "<br>";
                            }
    ...
    <center>
        <a href="<?php echo site_url('imagen_asociado/catalogoasoc/'.$id_asoc); ?>" class="btn btn-sq-lg btn-danger" style="width: 120px !important; height: 120px !important; " ><span class="fa fa-sign-out fa-4x"></span><br>Salir</a>
    </center>
</div>
</div>
