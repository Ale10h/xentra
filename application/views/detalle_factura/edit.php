				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_fact" value="<?php echo ($this->input->post('id_fact') ? $this->input->post('id_fact') : $detalle_factura['id_fact']); ?>" class="form-control" id="id_fact" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tipo_detfact" value="<?php echo ($this->input->post('tipo_detfact') ? $this->input->post('tipo_detfact') : $detalle_factura['tipo_detfact']); ?>" class="form-control" id="tipo_detfact" />
						</div>
					</div>
					<div class="col-md-6">
